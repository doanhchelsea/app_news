...
Future<List<News>> fetchNews(http.Client client) async {
  const URL_NEWS = URL + '/get_arc_by_catid?catid=1';
...
class WorldNews extends StatefulWidget {
  ...
  WorldNews({Key key, this.child}) : super(key: key);

  _SocietyNewsState createState() => _SocietyNewsState();
}

class _SocietyNewsState extends State<WorldNews> {
  @override
